...
export const Home = () => {
  ...
  return (
    ...
    <img className="sm:hidden md:flex w-full h-screen" src={bgg}></img>
  </div>
      <div name="home" className="">
        ...
        <div className=" flex flex-row ">
          <div className=" flex-1 flex pl-3  flex-col">
            ...
            <div className="flex justify-center text-2xl text-center">
              {" "}
         Reach out Africa  a non profit orrganisation Reach out Africa  a non profit orrganisation Reach out Africa  a non profit orrganisation 
         Reach out Africa  a non profit orrganisation Reach out Africa  a non profit orrganisation Reach out Africa  a non profit orrganisation
         Reach out Africa  a non profit orrganisation Reach out Africa  a non profit orrganisation vReach out Africa  a non profit orrganisation
            </div>
          </div>
...
<div className="my-10 text-left max-w-[1150px] border-l-4 pl-3 md:auto sm:ml-5 sm:px-5 border-red-400 flex md:mx-auto justify-center items-left flex-col "> 
<p className="text-3xl font-bold">Our Vision</p>
<p className="text-2xl">to the people in our communities. We feel the need of the suffering and that we reach out 
            in kind and other humanitarian services to help as much as we can</p>
</div>
      ...
      >
        <div className=" flex md:flex-row shadow-md sm:flex-col w-full h-full ">
          <div className=" flex-2 w-full ">
            <p className="p-3  text-3xl font-bold ">Our Projects</p>
            <p className="p-3  text-left text-2xl">
            We embark on charity projects with the aim of helping the impoverished, less endowed and as well 
            giving hope to the people in our communities. We feel the need of the suffering and that we reach out 
            in kind and other humanitarian services to help as much as we can
            </p>
            <div className=" flex items-center justify-center ">
            <Link to="/projects">  <button className="text-black bg-orange-300 group border-2 px-6 py-3 my-2 flex  items-center ">
                view more{" "}
          ...
          <div>
            <img className="px-5 md:flex flex-1 h-80 w-[1000px] sm:hidden " src={hop}></img>
          </div>
        </div>
      </div>
      ...
      >
        ...
        <div className=" gap-5 items-center my-10 sm:px-5  grid md:grid-cols-3 sm:grid-cols-2  justify-center ">
        ...
        <div className="shadow-md rounded-md flex-1 sm:mb-5 md:rows-span-1 mx-auto mb-5 sm:rows-span-1 ">
          ...
          <p className="p-3 text-center text-2xl">Reach Out Upperwest</p>
          <p className="p-3 text-2xl ">
            {" "}
            Location : lassu <br></br>
           Date: 21/5/21
           
          </p>
        </div>

        <div className="shadow-md rounded-md flex-1 sm:mb-5  ">
          <img className=" w-full " src={p1}></img>
          <p className="p-3 text-center text-2xl">Reach Out Upperwest</p>
          <p className="p-3 text-2xl ">
            {" "}
      ...
      <div
        name="quote  "
        className="  items-center w-full bg-orange-300 pb-7  flex  "
      >
        <div className=" flex mx-auto flex-col justify-around px-10 py-10 max-w-[1150px] h-full ">
         
          <div><p className=" text-center text-6xl">...</p></div>
            <p className=" text-center text-4xl sm:text-3xl">
         You may find a helping hand if in need at the end of your arm.
            </p>
            <p className=" text-center text-4xl sm:text-3xl">
          You will then discover that we were given two hands for a reason: one for helping yourself and another for 
          helping others... 
            </p>
           <div > <p className="mt-[-30px] text-center text-6xl">...</p></div>
      ...
      <div name="team" className="max-w-[1150px] mx-auto my-10  ">
        ...
        <div className="grid md:grid-cols-4 sm:grid-cols-2  items-center gap-5 ">

          <div className="shadow-md rounded-md md:rows-span-1 mx-auto mb-5 sm:rows-span-1 ">
            <img className="w-full " src={mn}></img>
            <p className="p-3 text-center text-2xl">Founder</p>
            <p className="p-3 text-center  bg-orange-100 text-1xl">
              {" "}
              Monique Ohenewaa Nkrumah
            </p>
          </div>

          <div className="shadow-md rounded-md md:rows-span-1 mx-auto mb-5 sm:rows-span-1 ">
            <img className="w-full" src={gg}></img>
            <p className="p-3 text-center text-2xl">Volunteer</p>
            <p className="p-3 text-center bg-orange-100 text-1xl">
              {" "}
              Georgina Gyebi
            </p>
          ...
          <div className="shadow-md rounded-md md:rows-span-1 mx-auto mb-5 sm:cols-span-2 ">
      ...
      <div
        name="donate"
        className=" mx-auto  md:flex items-center my-10   justify-center "
      >
        <div className=" md:flex  max-w-[1150px] flex-row w-full h-full gap-4">
          <div className="p-7 flex-1 shadow-md  bg-[#d1673d]">
            <p className=" text-white font-bold text-8xl">Donate</p>
  ...
  <ul>
      ...
      <div
        name="quote  "
        className="  items-center w-full bg-orange-500 pb-7  flex  "
      >
        <div className=" flex mx-auto flex-col justify-around px-10 py-10 max-w-[1150px] h-full ">
        ...
        <p className=" p-3 border-4 text-2xl rounded-[50px] text-white mx-auto " >Become A Volunteer</p>
